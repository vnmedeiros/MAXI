...
#ifndef IPV4_JOINT_ROUTING_HELPER_H
#define IPV4_JOINT_ROUTING_HELPER_H
...
/**
 * \brief Helper class that adds ns3::Ipv4JointRouting objects
 *
 * This class is expected to be used in conjunction with 
 * ns3::InternetStackHelper::SetRoutingHelper
 */
class Ipv4JointRoutingHelper : public Ipv4RoutingHelper
{
public:
  /*
   * Construct an Ipv4JointRoutingHelper object, used to make configuration
   * of joint routing easier.
   */
  Ipv4JointRoutingHelper ();

  /**
   * \brief Construct an Ipv4JointRoutingHelper from another previously 
   * initialized instance (Copy Constructor).
   */
  Ipv4JointRoutingHelper (const Ipv4JointRoutingHelper &);

  /**
   * \internal
   * \returns pointer to clone of this Ipv4JointRoutingHelper
   *
  ...
  /**
   * Try and find the joint routing protocol as either the main routing
   * protocol or in the list of routing protocols associated with the 
   * Ipv4 provided.
   *
   * \param ipv4 the Ptr<Ipv4> to search for the joint routing protocol
   */
  //Ptr<Ipv4JointRouting> GetJointRouting (Ptr<Ipv4> ipv4) const;
  Ptr<JointRouting> GetJointRouting (Ptr<Ipv4> ipv4) const;
...
private:
   ...
   */
  Ipv4JointRoutingHelper &operator = (const Ipv4JointRoutingHelper &o);
};

} // namespace ns3

#endif /* IPV4_JOINT_ROUTING_HELPER_H */
