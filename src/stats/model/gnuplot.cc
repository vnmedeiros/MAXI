                                           ...
                                           std::string &dataFileName) const
{
  ...
  switch (m_style) {
    case LINES:
      os << " with lines ls " << dataFileDatasetIndex + 1;
      break;
    case POINTS:
      switch (m_errorBars)
        {
    ...
    case LINES_POINTS:
      switch (m_errorBars)
        {
        case NONE:
          os << " with linespoints ls " << dataFileDatasetIndex + 1;
          break;
        case X:
          os << " with errorlines ls " << dataFileDatasetIndex + 1;
          break;
        case Y:
          os << " with yerrorlines ls " << dataFileDatasetIndex + 1;
          break;
        case XY:
          os << " with xyerrorlines ls " << dataFileDatasetIndex + 1;
          break;
        }
      break;
    case DOTS:
    ...
    case IMPULSES:
      ...
      break;
    case STEPS:
      os << " with steps ls " << dataFileDatasetIndex + 1;
      break;
    case FSTEPS:
      os << " with fsteps ls " << dataFileDatasetIndex + 1;
      break;
    case HISTEPS:
      os << " with histeps ls " << dataFileDatasetIndex + 1;
      break;
    }
...
Gnuplot::GenerateOutput (std::ostream &os) {
	this->GenerateOutput (os, false);
}

void
Gnuplot::GenerateOutput (std::ostream &os, bool multiplot)
{
  ...
  GenerateOutput (os, os, "", multiplot);
}
      ...
      if (!isDataEmpty)
        {
          ...
          i->m_data->PrintExpression (osControl,
                                      ...
                                      m_dataFileDatasetIndex % m_datasets.size(),
                                      dataFileName);
