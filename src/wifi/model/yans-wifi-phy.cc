...
YansWifiPhy::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::YansWifiPhy")
	...
	.AddTraceSource ("UpdateLinkQuality",
						 "UpdateLinkQuality",
						 MakeTraceSourceAccessor (&YansWifiPhy::m_tracedUpdateLinkQuality),
						 "ns3::YansWifiPhy::UpdateLinkQualityCallback")
  ;
  return tid;
}
...
void YansWifiPhy::NotifyUpdateLinkQuality(Ptr<Packet> packet, int nodeId, double snr, double sinr, double per, bool received) {
	InfoTag it;
