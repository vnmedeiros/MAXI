...
int main (int argc, char *argv[])
{
  ...
  YansWifiChannelCustomHelper channel = YansWifiChannelCustomHelper::Default ();
  YansWifiPhyCustomHelper phy = YansWifiPhyCustomHelper::Default ();
  phy.SetPcapDataLinkType (YansWifiPhyCustomHelper::DLT_IEEE802_11_RADIO);
