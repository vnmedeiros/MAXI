...
public:
  ...
  Gnuplot2dDataset Run (const WifiHelper &wifi, const YansWifiPhyCustomHelper &wifiPhy,
                        const WifiMacHelper &wifiMac, const YansWifiChannelCustomHelper &wifiChannel, const MobilityHelper &mobility);
...
Gnuplot2dDataset
Experiment::Run (const WifiHelper &wifi, const YansWifiPhyCustomHelper &wifiPhy,
                 const WifiMacHelper &wifiMac, const YansWifiChannelCustomHelper &wifiChannel, const MobilityHelper &mobility)
{
  ...
  YansWifiPhyCustomHelper phy = wifiPhy;
...
int main (int argc, char *argv[])
{
  ...
  YansWifiPhyCustomHelper wifiPhy = YansWifiPhyCustomHelper::Default ();
  YansWifiChannelCustomHelper wifiChannel = YansWifiChannelCustomHelper::Default ();
