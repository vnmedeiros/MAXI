...
public:
  ...
  uint32_t Run (const WifiHelper &wifi, const YansWifiPhyCustomHelper &wifiPhy,
                const WifiMacHelper &wifiMac, const YansWifiChannelCustomHelper &wifiChannel);
private:
      ...
      for (double rss = -102.0; rss <= -80.0; rss += 0.5)
        {
          ...
          YansWifiChannelCustomHelper wifiChannel;
